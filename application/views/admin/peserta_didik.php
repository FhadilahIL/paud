...
<div class="m-3 card">
    <div class="card-body">
        <button type="button" class="btn btn-secondary mb-3" data-toggle="modal" data-target="#staticModalTambahPesertaDidik">
            ...
            <tbody>
                ...
                foreach ($murid as $murid) { ?>
                    <tr>
                        ...
                        <td><?= $murid->status; ?></td>
                        <td class="text-center"><a href="<?= base_url('admin/ubah_peserta/' . $murid->id_peserta) ?>" class="btn btn-warning text-light tombol-aksi">Edit</a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
