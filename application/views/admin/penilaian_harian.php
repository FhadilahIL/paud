            ...
            <table class="table table-responsive" id="table_penilaian_harian">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="text-center aksi">Tanggal</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($nilai as $nilai) { ?>
                        <tr>
                            ...
                            <td class="text-center"><?= date('d M Y', strtotime($nilai->tanggal_penilaian)) ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    foreach ($catatan_harian as $catatan) { ?>
                        <tr>
                            ...
                            <td class="text-center"><?= date('d F Y', strtotime($catatan->tanggal_catatan)) ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
