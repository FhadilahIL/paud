		...
		$.ajax({
			...
			success: function (data) {
				...
				if (data) {
					...
					html += '<select name="mata" id="mata" class="form-control select" required>'
					...
					html += '<select name="mulut" id="mulut" class="form-control select" required>'
					...
					html += '<select name="gigi" id="gigi" class="form-control select" required>'
					...
					html += '<select name="telinga" id="telinga" class="form-control select" required>'
					...
					html += '<select name="hidung" id="hidung" class="form-control select" required>'
					...
					html += '<select name="anggota_badan" id="anggota_badan" class="form-control select" required>'
					...
					html += '<input type="number" maxlength="3" class="form-control col-1" id="berat_badan" name="berat_badan" required />'
					html += '<label class="mt-3">Tinggi Badan <sub><strong>(Cm)</strong></sub></label>'
					html += '<input type="number" maxlength="3" class="form-control col-1" id="tinggi_badan" name="tinggi_badan" required />'
		...
		$.ajax({
			...
			success: function (data) {
				...
				if (data) {
					...
					html += '<select name="menangis" id="menangis" class="form-control select" required>'
					...
					html += '<select name="memukul" id="memukul" class="form-control select" required>'
					html += '<option value="">-- Pilih Emosi Peserta --</option>'
					html += '<option value="Tidak Pernah">Tidak Pernah</option>'
					html += '<option value="Kadang">Kadang</option>'
					html += '<option value="Sering">Sering</option>'
					...
					html += '<select name="marah" id="marah" class="form-control select" required>'
					html += '<option value="">-- Pilih Emosi Peserta --</option>'
					html += '<option value="Tidak Pernah">Tidak Pernah</option>'
					html += '<option value="Kadang">Kadang</option>'
					html += '<option value="Sering">Sering</option>'
					...
					html += '<select name="diam" id="diam" class="form-control select" required>'
					html += '<option value="">-- Pilih Emosi Peserta --</option>'
					html += '<option value="Tidak Pernah">Tidak Pernah</option>'
					html += '<option value="Kadang">Kadang</option>'
					html += '<option value="Sering">Sering</option>'
					...
					html += '<select name="melamun" id="melamun" class="form-control select" required>'
					html += '<option value="">-- Pilih Emosi Peserta --</option>'
					html += '<option value="Tidak Pernah">Tidak Pernah</option>'
					html += '<option value="Kadang">Kadang</option>'
					html += '<option value="Sering">Sering</option>'
					...
					html += '<select name="gembira" id="gembira" class="form-control select" required>'
					html += '<option value="">-- Pilih Emosi Peserta --</option>'
					html += '<option value="Tidak Pernah">Tidak Pernah</option>'
					html += '<option value="Kadang">Kadang</option>'
					html += '<option value="Sering">Sering</option>'
